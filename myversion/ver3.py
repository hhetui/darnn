...
# encoding: utf-8
'''
将Encoder 和 Decoder 模型部分换成自己的模型
'''
import os
import math
import pickle
...
class Trainer:
    ...
    def train_minibatch(self, num_epochs):
        ...
        for epoch in range(num_epochs):
            ...
            result['test_random'].append(test_random)
            result['test_accuarcy'].append(test_accuracy)
        ...
        pd.DataFrame(result).to_csv(r_name)
...
if __name__ == '__main__':
    ...
    print('time_step:',time_step, 'hidden_size:',hidden_size, 'lr:',lr, 'batch_size:',batch_size, 'drop_ratio:',drop_ratio, 'split:',split)
